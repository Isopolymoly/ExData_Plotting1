...
dateslice$volts <- as.numeric(levels(dateslice$Voltage))[dateslice$Voltage]
dateslice$GRP <- as.numeric(levels(dateslice$Global_reactive_power))[dateslice$Global_reactive_power]
